...
@Component({
  selector: 'app-data-analisis-bpd',
  templateUrl: './data-analisis-bpd.component.html',
  styleUrls: ['./data-analisis-bpd.component.scss']
})
export class DataAnalisisBpdComponent {
