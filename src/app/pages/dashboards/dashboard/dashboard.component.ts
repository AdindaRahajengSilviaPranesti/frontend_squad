...
import {TopSelling, RecentSelling, statData } from './data';
...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (localStorage.getItem('toast')) {
      const message = `Hello ${this.tokenStorageService.getUser().nama}`;
      this.toastService.show(message, {classname:'bg-success text-center text-white', delay:5000})
